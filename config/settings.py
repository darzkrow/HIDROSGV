...
import os
env = environ.Env(
    # Establece valores por defecto y convierte en tipos esperados
    DEBUG=(bool, False)
)
...
# Ahora puedes usar las variables de entorno en tu configuración de Django
DEBUG = env('DEBUG')
...
MIDDLEWARE = MIDDLEWARE_THIRD + MIDDLEWARE_DJANGO + MIDDLEWARE_LOCAL
